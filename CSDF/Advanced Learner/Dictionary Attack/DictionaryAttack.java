...
public class DictionaryAttack {
	...
	public static void main(String[] args) throws Exception {
        ...
        File passwords_file = new File("C:\\Users\\MurthyVSSN\\eclipse-workspace\\DicAttack\\password.txt");
        ...
        File fin = new File("C:\\Users\\MurthyVSSN\\eclipse-workspace\\DicAttack\\english.0");
    	...
    	while ((line = br.readLine()) != null) {
    		...
    		while (salted_passwords_it.hasNext()) {
    	        ...
    	        byte[] account_password_hash_salt = hexStringToByteArray(salted_passwords_salts.get(account_name));
    	        //We test if the password matches an unmodified dictionary entry
